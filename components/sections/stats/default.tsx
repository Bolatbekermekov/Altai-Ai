  ...
  items = [
    {
      label: "клиентов",
      value: 4,
      description: "первые коммерческие проекты и референсы",
    },
    {
      label: "запуска",
      value: 5,
      description: "лендинги, боты, CRM и мобильные MVP",
    },
    {
      label: "срок MVP",
      value: "2–4",
      suffix: " нед.",
      description: "от брифа до первой версии",
    },
    {
      label: "оценка",
      value: "5/5",
      description: "по текущим отзывам",
    },
  ],
  className,
}: StatsProps) {
