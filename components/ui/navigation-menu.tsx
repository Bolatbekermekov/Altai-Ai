...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      onPointerEnter={(e) => e.preventDefault()} // Блокировать hover
      onPointerMove={(e) => e.preventDefault()} // Блокировать hover
      onPointerLeave={(e) => e.preventDefault()} // Блокировать hover
      {...props}
    >
      {children}{" "}
      <ChevronDownIcon
